...
<div class="content">
    <div class="form-card">
        ...
        <form method="POST" action="/mata-kuliah/update/{{ $matkul->kode_matkul }}">
            @csrf

            <input type="text" value="{{ $matkul->kode_matkul }}" disabled>
            <input type="text" name="nama_matkul" value="{{ $matkul->nama_matkul }}" required>
            <input type="number" name="sks" value="{{ $matkul->sks }}" required>
            <input type="number" name="semester" value="{{ $matkul->semester }}">
            <input type="text" name="kategori_bidang" value="{{ $matkul->kategori_bidang }}">
